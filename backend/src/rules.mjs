...
function Il(e, now=Date.now()) {
  ...
  if(e.campaign>=2)income.wood+=8;if(e.campaign>=3)income.stone+=8;if(e.campaign>=4)income.gold+=12;
...
export {Al,Y,Ul,Wl,Kl,Gl,wl,J,Fu,Jl,Gc,Hl,Ll,SWCapacity,SWRaidLoot,SWDefenseInput,SWResolveDefense,SWRaidStatus,SWRaidInput,SWSettleScheduledRaid,SWDefenseReport,Jc,SWNavalShips,SWEnemyNavy,ml,pl,Ml,Nl,Pc,Ac,Tl,SWPremiumCatalog,SWPremiumCollections,SWGrantCollection,SWRevokeCollection,SWSagaInput,SWSagaSettle,SWChapter,SWEvents,SWTrials,SWAppearance,SWMedievalFinale,SWCreateBattle14,SWSeaChapters14,SWSeaDefense14,SWOrders14,SWValidateShipOrders14,SWValidateCargo14,SWPackCargo14,SWLoadout14,SWUpgradeQuote14,SWTrainQuote14};
export const RULES_HASH="aafb3d31585492131968c187e749bf52b0aee61bee321a4215e60cc43c6fd4d3";
