function Ju({ deviceOnly: e = !1 } = {}) {
  ...
  let Ae = (0, C.useCallback)(() => {
    ...
    sn = (0, C.useRef)(null),
    cn = (0, C.useRef)(null);
  SWUseMusic(B?(B.result.won?'victory':'calm'):L?'battle':I?'scout':'calm',stonewakeMusic,musicVolume);
  ...
  ((0, C.useEffect)(() => {
    ...
    (0, C.useEffect)(() => {
      if (
        ...
        (R?.rulesVersion === 4 &&
          ...
          o !== 'cloud' &&
          !R.orders?.length &&
          R.navalAt === void 0 && !(R.navalVersion>=2&&R.navalSupport) &&
          R.retreatAt === void 0)
      )
        return;
    ...
    }, [L, z, B, dt, R?.orders?.length, R?.navalAt, R?.navalSupport, St, o]),
    (0, C.useEffect)(() => {
  ...
  function SWNavigate(destination) {
    ...
    else if(destination==='plan'){p('capital');ee('road')}
    else if(destination==='commander')Ut(true);
    else if(destination==='achievements')Je(true);
  ...
  async function vn(e, t) {
    ...
    if (g) {
      ...
      v &&
        (await mn({ type: `move`, id: v, x: e, y: t, facing: buildFacing }, `Building moved`)) &&
        (y(null), Ft(null), h(v));
  }
  function yn(e) {
    setNavalId('');
      ...
      try {
        ...
        if (o === 'practice' && ['saga','trial'].includes(I.kind)) {
          ...
          let t = {
            ...
            navalVersion: 3,
            enemyNavy: SWEnemyNavy(I.defense),
            troopAbilitiesVersion: 1,
            navalSupport: SWNavalEligible(I) && navalId ? (() => {
              const ship=SWNavalShips(Y(r.current)).find(ship=>ship.id===navalId);
              if(!ship) throw Error('That ship is no longer ready. Choose an idle warship.');
              return {id:ship.id,kind:ship.kind,level:ship.level};
            })() : undefined,
            orders: [],
            ...
            structureBonus:
              1 +
              0.05 *
                (V.provinces?.find((e) => e.id === `ironpass`)?.level || 0),
          ...
          if (
            ...
            let t = Y(r.current);
            if(e.input.navalSupport){const ship=t.fleet.find(ship=>ship.id===e.input.navalSupport.id);if(ship)ship.combatBattleId=e.id;}
            ((t.army = wl()), (t.activeBattle = e.id), t.revision++, n(t));
          }
        } else {
          const response=await window.SWOnline.request('/v1/battles/start',{method:'POST',body:{requestId:window.SWOnlineGame.requestId(),revision:swOnlineRevision.current,kind:I.kind,missionId:I.missionId,trialId:I.trialId,campaignIndex:I.campaignIndex,provinceId:I.provinceId,targetId:I.rivalId||I.id,army:{...V.army},navalShipId:navalId||undefined}});
          if(c.current!=='cloud'||epoch!==swOnlineEpoch.current)return;
  ...
  async function xn() {
    if (!(!L || !R || !z)) {
      ...
      try {
        ...
        pt({ result: e, reward: t, practice: !1, saga:!!R.saga,missionId:R.saga?.missionId,trialId:R.saga?.trialId,earnedGems:Math.max(0,r.current.gems-battleStartingGems) });
      } catch (e) {
  ...
  function SWQueueSimulation(input) {
    ...
    swBattleRuntime.current.request(input,result=>{swSimulationPending.current=false;ct(result)},error=>{swSimulationPending.current=false;_t(error)});
  }
  function Sn(e, t, options = {}) {
    const input=swBattleInput.current;
    if (!input || input.rulesVersion !== 4 || St || B || mt || lt >= 119.5 || (L?.kind==='defense'||input.saga?.mode==='hold')) return false;
    if (!pl(input.defense, e, t)) {
      if (!options.silent) ic(`Deploy along the outside edge.`, {id:`deployment-hint`, duration:1000});
      return false;
    }
    if (!hl(input)[le]) return false;
    if(c.current==='cloud'&&L.kind!=='practice') {
      if(!swOnlineQueue.current?.enqueue({type:'deploy',kind:le,x:e,y:t}))return false;
      He('march');SWHaptic('deploy');window.dispatchEvent(new CustomEvent('hearth-burst',{detail:{x:e,y:t,label:''}}));return true;
    }
    const next={...input,orders:[...(input.orders||[]),{kind:le,x:e,y:t,time:Math.max(input.orders?.at(-1)?.time||0,Math.ceil(lt*2)/2)}]};
    SWQueueSimulation(next);
    He('march');SWHaptic('deploy');
    window.dispatchEvent(new CustomEvent('hearth-burst',{detail:{x:e,y:t,label:''}}));
    return true;
  }
  function Cn() {
    if (!R || St || B) return;
    ...
    children: [
      ...
      (0, F.jsxs)(`header`, {
        ...
        children: [
          ...
          !L && swElement(SWQuickNav,{state:V,navigate:SWNavigate,current:b?'army':cityOpen?'city':chronicleTab?'chronicle':f}),
          (0, F.jsxs)(`div`, {
        ...
        ? (0, F.jsxs)(`section`, {
            ...
            children: [
              (0, F.jsx)(Eu, {
                ...
                playbackSpeed: dt,
                enemy: !0,
                deployment: R.rulesVersion === 4 && !St && !B && L.kind!=='defense' && R.saga?.mode!=='hold',
                onDeploy: Sn,
                selectedTroop:le,reserveCount:R?hl(R)[le]:0,defending:L.kind==='defense'||R.saga?.mode==='hold',
                navalSupport: R.navalSupport,
              }),
              (0, F.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, F.jsx)(`p`, {
                    children: R.saga?.label || (L.kind==='defense'?`Hold your keep against the coastal raiders.`:`Destroy the enemy keep to win.`),
                  }),
                ],
              }),
              (0, F.jsxs)(`div`, {
                ...
                children: [
                  ...
                  (0, F.jsxs)(`span`, {
                    children: [
                      (0, F.jsx)(be, { size: 17 }),
                      kn?.units.filter((e) => e.side === `attack` && e.hp > 0)
                        .length || 0,
                    ],
                  }),
                ],
              }),
              kn?.objective && !B && swElement('div',{className:'sw-saga-objective',role:'status'},swElement('span',null,kn.objective.label),swElement('progress',{max:1,value:kn.objective.progress,'aria-label':'Mission progress'}),kn.objective.escortHealth!==null&&swElement('small',null,'Escort '+Math.round(kn.objective.escortHealth*100)+'%')),
              !B && (L.kind==='defense'||R.saga?.mode==='hold') ? swElement('div',{className:'sw-defense-controls'},swElement('strong',null,'Defend the keep'),swElement('span',null,'Your walls and towers fight automatically'),swElement('button',{className:'secondary',onClick:()=>ft(dt===1?2:1)},dt+'× speed')) : !B && (0, F.jsx)(SWBattleControls, {
                input: R, frame: kn, selected: le, onSelect: M, onRetreat: Cn,
                disabled: mt||!!onlineBattleError, replay: St, speed: dt, onSpeed: o==='cloud'&&!St&&L.kind!=='practice'?null:() => ft(e => e === 1 ? 2 : 1),
                onRally: wn, onAbility: Tn, onNaval: SWFireBroadside, navalHull:kn?.units.find(u=>u.naval),
              }),
        ...
        : f === `frontier`
          ? (0, F.jsxs)(`section`, {
              ...
              children: [
                  ...
                  children: [
                    (0, F.jsxs)(`div`, {
                      children: [
                        ...
                        (0, F.jsx)(`h1`, { children: `The frontier` }),
                        (0, F.jsx)(`p`, {
                          children: `Conquer land. Forge rivalries. Raise your banner.`,
                        }),
                      ],
                    }),
                    (0, F.jsx)(Ls, {
                      ...
                      children: (0, F.jsxs)(zs, {
                        ...
                        children: [
                          (0, F.jsxs)(Bs, {
                            value: `campaign`,
                            children: [(0, F.jsx)(j, { size: 16 }), `Campaign`],
                          }),
                          (0, F.jsxs)(Bs, {
                            value: `provinces`,
                            children: [
                ...
                tt === `campaign`
                  ? (0, F.jsxs)(`div`, {
                      className: `campaign-board campaign-chapters`,
                      children: [
                        (0, F.jsx)(`svg`, {
                          ...
                          children: (0, F.jsx)(`path`, {
                            d: `M240 442 Q300 290 420 338 T620 221 Q770 200 760 370 T850 143`,
                          }),
                        }),
                        Tl.map((e, t) => {
                          let n = t > V.campaign,
                          ...
                          return (0, F.jsxs)(
                            `button`,
                            {
                              className: `campaign-node ${n ? `locked` : ``} ${r ? `captured` : ``}`,
                              style: { left: `${e.x}%`, top: `${e.y}%` },
                              onClick: () =>
                                n
                                  ? ic(
                                      `Capture the previous stronghold to open this route.`,
                                    )
                                  : yn({
                                      kind: `campaign`,
                                      defense: Gl(t),
          ...
          : (0, F.jsxs)(`section`, {
              ...
              children: [
                (0, F.jsx)(Eu, {
                  ...
                  onSelect: (e) => {
                    (h(e.id), p(`capital`), He());
                    if(e.kind === `harbor` && !e.readyAt) w(true);
                  },
                  onPlace: _n,
                }),
                T
                  ...
                  : g === `wall`
                    ...
                    : g || v || ornamentPlacement
                      ? (0, F.jsxs)(`div`, {
                          ...
                          children: [
                            ...
                            (0, F.jsx)(`button`, {
                              ...
                              onClick: () => {
                                const wasNew=!!g;setOrnamentPlacement(null); _(null); y(null); Ft(null); if(wasNew)p('build');
                              },
                              children: (0, F.jsx)(je, { size: 20 }),
                            }),
                          ],
                      ...
                      : H
                        ? (0, F.jsxs)(SWBuildingPanel, {
                            children: [
                              (0, F.jsx)(`button`, {
                                className: `panel-close`,
                                "aria-label": `Close building details`,
                                onClick: () => h(null),
                                children: (0, F.jsx)(je, { size: 18 }),
                              }),
                              (0, F.jsxs)(`div`, {
                                className: `building-detail-heading`,
                                children: [
                                  (0, F.jsx)(tu, {
                                    building: H,
                              ...
                              (0, F.jsx)(`p`, {
                                children: Sl[H.kind].description,
                              }),
                              (0, F.jsxs)(`div`, {
                                className: `benefit`,
                                children: [(0, F.jsx)(te, { size: 15 }), Bl(H)],
                              }),
                              H.readyAt && swElement('button', {className:'sw-speedup secondary wide',onClick:()=>setGemShopOpen(true)},'Finish now · '+GemCost(H.readyAt)+' ◆'),
                              H.readyAt
                                ? (0, F.jsxs)(`div`, {
                              ...
                              H.kind === `market` && H.level > 0 && swElement(SWMarketTrade,{state:V,act:mn,busy:l}),
                              H.kind === `barracks` &&
                                H.level > 0 &&
                                (0, F.jsxs)(`button`, {
                                  className: `secondary wide building-action`,
                                  onClick: () => x(!0),
                                  children: [
                                    (0, F.jsx)(we, { size: 18 }),
                                    `Train troops`,
                              ...
                              H.kind === `keep` &&
                                ...
                                (0, F.jsx)(`p`, {
                                  ...
                                  children:
                                    H.level === 1
                                      ? `Next keep: cavalry, shieldbearers, scouts and foundries.`
                                      : `Next keep: crossbowmen, battering rams and stronger defenses.`,
                                }),
                              swElement(hu, {building:H}),
                              H.kind === `harbor` &&
                                H.level > 0 &&
                                (0, F.jsxs)(`button`, {
                                  className: `primary wide`,
                              ...
                              (H.kind === `wall` || H.kind === `gate`) &&
                                (0, F.jsxs)(`div`, {
                                  className: `fortification-actions`,
                                  children: [
                                    H.kind === `wall` &&
                                      (0, F.jsx)(`button`, {
                                        ...
                                        children: `Add gate · 15 gold / wood / stone`,
                                      }),

                                  ],
                                }),
                              swElement('div',{className:'sw-building-tools'},swElement('button',{className:'secondary',onClick:()=>{setBuildFacing(H.facing||0);Ft(null);y(H.id);h(null)}},swElement(pe,{size:15}),'Move'),swElement('button',{className:'secondary',disabled:l,onClick:()=>void mn({type:'rotate',id:H.id})},swElement(ge,{size:15}),'Rotate · '+((H.facing||0)*90)+'°')),
                            ],
                          })
                        : null,
                Zt &&
                    ...
                    children: [
                        ...
                        children: [
                          (0, F.jsxs)(`div`, {
                            children: [
                              ...
                              (0, F.jsx)(`h2`, { children: `Build your town` }),
                            ],
                          }),
                          (0, F.jsx)(`button`, {
                            className: `icon-btn`,
                      ...
                      (0, F.jsx)(Ls, {
                        ...
                        children: (0, F.jsxs)(zs, {
                          ...
                          children: [
                            (0, F.jsx)(Bs, { value: `all`, children: `All` }),
                            (0, F.jsx)(Bs, { value: `town`, children: `Town` }),
                            (0, F.jsx)(Bs, {
                              value: `resources`,
                              children: `Resources`,
                            }),
                      ...
                      (0, F.jsx)(`div`, {
                        ...
                        children: Object.keys(Sl)
                              ...
                              (Bt === `all` ||
                                (Bt === `town`
                                  ? [
                                      `cottage`,
                                      `market`,
                                      `well`, `storehouse`, `workshop`, `tavern`,
                                      `harbor`,
                                      `builder`,
                                      `monument`,
                                    ]
                          ...
                          .map(kind=>swElement(SWBuildCard,{key:kind,kind,state:V,busy:l,onBuild:gn})),
                      }),
                      (0, F.jsxs)(`p`, {
                        className: `tray-note`,
                        children: [
                          ...
                          ` builders free. `,
                          en < 4
                            ? `Build a Builder’s lodge for another permanent crew.`
                            : `Your four crews can work at the same time.`,
                        ],
                      }),
                    ],
                  }),
      ...
      swElement(SWArmy, {open:b,onClose:()=>x(false),state:V,act:mn,busy:l,onFrontier:()=>{x(false);p('frontier')},onCommander:()=>{x(false);Ut(true)}}),
      swElement(SWScout, {open:!!I,onClose:()=>rt(null),scout:I,state:V,busy:l,navalId,onNavalChange:setNavalId,onAttack:()=>void bn(),onTrain:()=>{rt(null);x(true)}}),
      (0, F.jsx)(As, {
        open: !!B,
        onOpenChange: (e) => {
          !e && B && En();
        ...
        children:
          ...
          (0, F.jsx)(SWResultContent, {
            defenseReport: B.defenseReport,objective:B.saga?B.result.objective:null,earnedGems:B.earnedGems,onRetry:B.saga&&!St&&(!B.result.won||B.trialId)?()=>{const missionId=R.saga.missionId,trialId=R.saga.trialId;En();SWStartAdventure(SWMissionScout(Y(r.current),missionId,trialId))}:null,
              ...
              (0, F.jsxs)(F.Fragment, {
                children: [
                      ...
                      (0, F.jsx)(Is, {
                        children:
                          B.saga ? (B.result.objective?.label||R.saga.label) : B.defense
                            ...
                            : B.result.won
                              ? `${R?.defense.name} is yours. Your banner flies higher.`
                              : `The enemy keep still stands. Try a different approach or strengthen your army.`,
                      }),
                    ],
                  }),
                  (0, F.jsx)(`div`, {
                  ...
                  (0, F.jsxs)(`button`, {
                    ...
                    children: [
                      B.saga?'Return to Adventures ':`Return to your capital `,
                      (0, F.jsx)(ne, { size: 18 }),
                    ],
                  }),
                ],
